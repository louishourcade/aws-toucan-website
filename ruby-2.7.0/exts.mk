...
extensions = ext/ripper/. ext/stringio/. ext/digest/. \
	     ext/digest/bubblebabble/. ext/digest/md5/. \
	     ext/digest/rmd160/. ext/digest/sha1/. ext/digest/sha2/. \
	     ext/fiber/. ext/bigdecimal/. ext/fcntl/. \
	     ext/rbconfig/sizeof/. ext/socket/. ext/racc/cparse/. \
	     ext/cgi/escape/. ext/json/. ext/json/generator/. \
	     ext/json/parser/. ext/pathname/. ext/nkf/. ext/openssl/. \
	     ext/readline/. ext/psych/. ext/objspace/. \
	     ext/continuation/. ext/strscan/. \
	     ...
	     ext/-test-/wait_for_single_fd/. ext/etc/. ext/date/. \
	     ext/syslog/. ext/gdbm/. ext/pty/. ext/io/console/. \
	     ext/io/nonblock/. ext/io/wait/. ext/sdbm/. ext/dbm/. \
	     ext/monitor/. ext/zlib/. ext/coverage/. ext/rubyvm/. \
	     ext/fiddle/.
PLATFORM_DIR = 
RMALL = rm -fr
...
note-body:: note-header
	...
	@echo "	/local/home/lhourcad/Desktop/MDS/Toucan/front/aws-toucantoco/ruby-2.7.0/ext/readline/extconf.rb:62: Neither readline nor libedit was found"
